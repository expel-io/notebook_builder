...
class TestHunt():
    ...
    def test_normalize_hunt_df(self, hunt):
        ...
        '''
        columns = ['record_id', 'proc_first_seen', 'proc_last_seen', 'conn_first_seen', 'conn_last_seen', 'host', 'user', 'process_name', 'process_args', 'parent_name', 'domain', 'dest_ip', 'dest_port', 'netconns']
        test_obj = hunt.normalize_hunt_df(columns, pd.DataFrame(test_data))
        # print(test_obj.to_dict('records'))

        assert test_obj.to_dict('records') == [{'index': 0, 'process_first_seen': '2019-08-17T00:36:07', 'process_last_seen': '2019-09-30T00:36:07', 'connection_first_seen': '2019-08-17T00:37:29', 'connection_last_seen': '2019-09-30T00:37:39', 'process_name': 'w3wp.exe', 'process_args': 'c:\\windows\\systemDD\\inetsrv\\wDwp.exe -ap "clerkdocs"', 'parent_name': 'svchost.exe', 'user': 'IIS APPPOOL\\EvilClerk', 'host': 'clerk01', 'domain': 'api.dropboxapi.com', 'sensor_id': 425, 'dest_ip': '162.125.3.7', 'dest_port': 443, 'netconns': 45, 'event_id': 'cda92f81-db5f-4018-a6a4-e80e7a29b72d', 'record_id': '1000', 'proc_first_seen': '', 'proc_last_seen': '', 'conn_first_seen': '', 'conn_last_seen': ''}, {'index': 1, 'process_first_seen': '2019-08-17T00:33:04', 'process_last_seen': '2019-09-30T00:33:04', 'connection_first_seen': '2019-08-17T00:34:27', 'connection_last_seen': '2019-09-30T00:34:30', 'process_name': 'cmd.exe', 'process_args': 'c:\\windows\\systemDD\\cmd.exe -ap "clerkdocs"', 'parent_name': 'powershell.exe', 'user': 'EVIL\\EvilUSER', 'host': 'user01', 'domain': 'api.test2.com', 'sensor_id': 427, 'dest_ip': '162.125.4.8', 'dest_port': 80, 'netconns': 47, 'event_id': '9f78d2d8-7171-4d2f-9fd2-c0413aa83184', 'record_id': '1001', 'proc_first_seen': '', 'proc_last_seen': '', 'conn_first_seen': '', 'conn_last_seen': ''}]